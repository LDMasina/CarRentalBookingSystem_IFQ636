...
Cited references are included in some of the inline commentary of the code using APA Style referencing. Full References list provided in Assignment template that has been submitted via Canvas.
